...
############################  SETUP PARAMETERS
app_name='islayer-vim'
[ -z "$APP_PATH" ] && APP_PATH="$HOME/.islayer-vim"
[ -z "$REPO_URI" ] && REPO_URI='https://github.com/islayer/islayer-vim.git'
...
create_symlinks() {
    ...
    lnif "$source_path/.vim/settings.vim"   "$target_path/.vim/settings.vim"
    lnif "$source_path/.vim/settings"      "$target_path/.vim/"
